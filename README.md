...
**Live → https://baditaflorin.github.io/mesh-blind-date/**

**Source → https://github.com/baditaflorin/mesh-blind-date**
...
git clone https://github.com/baditaflorin/mesh-blind-date
cd mesh-blind-date
npm install
npm run dev
```
...
- `mesh-blind-date:signalingUrl`
- `mesh-blind-date:turnTokenUrl`
- `mesh-blind-date:iceServers`
- `mesh-blind-date:room`
