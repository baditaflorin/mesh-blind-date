# Security audit — mesh-blind-date

Generated: **2026-05-17T13:30:36.206Z** · 16 checks · 16 pass · 0 fail
...
```json
{
  "pubkeyA": "7313cfae9c31906948c46e345d0cbd299208978dbdfea1f6ec1c7ef5274ba183",
  "pubkeyB": "7313cfae9c31906948c46e345d0cbd299208978dbdfea1f6ec1c7ef5274ba183"
}
```
...
```json
{
  "pubkeyA": "ddc8fb2e78e904ed",
  "pubkeyB": "05d7731f2d03efc9"
}
```
...
```json
{
  "plantedExpiresAt": 1779024576200,
  "now": 1779024636203
}
```
...
```json
{
  "realPubkey": "4f631712f74ed8b1",
  "forgerPubkey": "28542ae0b0244ca0"
}
```
...
```json
{
  "forgedPubkey": "eee297e332d3010f",
  "realPubkey": "1a6f6a5c3ea72d96"
}
```
